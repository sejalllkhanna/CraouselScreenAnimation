...
@IBDesignable class HamburgerButton : UIButton {
    ...
    let menuStrokeStart: CGFloat = 1
    let menuStrokeEnd: CGFloat = 0
    
    let hamburgerStrokeStart: CGFloat = 0
    let hamburgerStrokeEnd: CGFloat = 1
    ...
    override func draw(_ rect: CGRect) {
        ...
        self.top.anchorPoint = CGPoint(x: 29.0 / 30.0, y: 0.5)
        self.top.position = CGPoint(x: 40, y: 18)
        
        self.middle.anchorPoint = CGPoint(x: 29/30, y: 0.5)
        self.middle.position = CGPoint(x: 40, y: 27)
    ...
    var showsMenu: Bool = false {
        didSet {
            ...
            if self.showsMenu{
                self.top.strokeColor = UIColor.white.cgColor
                self.bottom.strokeColor = UIColor.white.cgColor
                
            }else{
                self.top.strokeColor = UIColor.black.cgColor
                self.bottom.strokeColor = UIColor.black.cgColor
            }
